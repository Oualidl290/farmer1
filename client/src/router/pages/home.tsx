      ...
      <section id="pricing" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Choose the plan that works best for your farm's size and needs.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden">
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6">
                  Perfect for small farms up to 50 acres.
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    ...
                    <span className="text-gray-600">Basic crop management</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="h-5 w-5 text-green-500 mr-2"
              ...
              <div className="px-8 pb-8">
                <button className="w-full py-3 border border-green-600 text-green-600 rounded-lg hover:bg-green-50 font-medium">
                  Get Started
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg transform md:scale-105 overflow-hidden border-2 border-green-500">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6">
                  Ideal for farms between 50-200 acres.
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    <svg
                  ...
                  <li className="flex items-center">
                    ...
                    <span className="text-gray-600">Full inventory system</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="h-5 w-5 text-green-500 mr-2"
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden">
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6">
                  For large farms over 200 acres.
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    <svg
                    ...
                    <span className="text-gray-600">Everything in Medium</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="h-5 w-5 text-green-500 mr-2"
